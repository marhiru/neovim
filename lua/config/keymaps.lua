...
map("n", "<leader>uL", function()
    ...
    vim.notify(
        vim.opt.relativenumber and "Relative numbers enabled"
            or "Relative numbers disabled"
    )
...
map("n", "<leader>ul", function()
    ...
    vim.notify(
        vim.opt.number and "Line numbers enabled" or "Line numbers disabled"
    )
...
map("n", "<leader>u]", function()
    ...
    vim.notify(
        "Colorscheme: " .. themes[current_theme_index].display,
        vim.log.levels.INFO
    )
